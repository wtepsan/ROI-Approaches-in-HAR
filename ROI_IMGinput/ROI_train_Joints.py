...
if __name__ == '__main__':
    ...
    parser.add_argument('--choosing_frame_method', default="random", choices={'fix', 'randombegin_randomlength', 'random_from_each_interval', 'random', 'mix', 'min', 'max', 'btwmin', 'btwmax'})
    ...
    name_of_experiment = benchmark + "_" \
        +"_Input_" + imginput \
        +"_FrameSelection_"+ choosing_frame_method \
        + model_name+"_" \
        + optim_name+"_" \
        +loss_function_name \
    ...
    for i in range(num_epoch): 
        ...
        # correct, numberofdata, accuracy, losses, confusionmatrix
        ################################################
        # SAVE RESULT #
        ################################################
