...
xsub_pickle_roi5_btwmin = "/project/lt200210-action/wtepsan/xsub_roi5/evaluation/btwminxsub_roi5_btwmin_tensor9134_best_evaluation.pkl"
...
XSUB_PICKLE_LIST = [xsub_pickle_fullbody, xsub_pickle_body2parts, xsub_pickle_body3parts, xsub_pickle_roi3, xsub_pickle_roi4, xsub_pickle_roi5, xsub_pickle_roi5_btwmin, xsub_pickle_roi6, xsub_pickle_roi7]
...
if __name__ == '__main__':
    ...
    if protocol == 'xsub':
        ...
        print("XVIEW XVIEW XVIEW XVIEW XVIEW XVIEW XVIEW XVIEW")
    ## LOAD LABEL ###
    ...
    for picklename in picklenamelist:
        ...
        if picklename.find('xsub') != -1:
            ...
            protocol = 'xview'
            print(protocol)
        label_pickle = GCN_PICKLE_PATH+ '/data/ntu_st_gcn/' + protocol + '/val_label.pkl'
        label = open(label_pickle, 'rb')
        label = np.array(pickle.load(label))

        # if protocol == 'xview':
        #     notuseindex = np.where(label[0]=='S001C001P001R001A012.skeleton')
        #     label0 = np.delete(label[0], notuseindex)
        #     label1 = np.delete(label[1], notuseindex)
        ...
        for dataname in tqdm(datanames):
            ...
            r11_gcn = r1_gcn_dict[dataname]
            r22_gcn = r2_gcn_dict[dataname]
            ...
            r11_2s = r1_2s_dict[dataname]
            r22_2s = r2_2s_dict[dataname]
            r_2s = r11_2s + r22_2s
            ...
            r11_g3d = r1_g3d_dict[dataname]
            r22_g3d = r2_g3d_dict[dataname]
