...
if __name__ == '__main__':
    ...
    #   for picklename2 in picklenamelist:        
        ...
        for dataname in tqdm(datanames):
            ...
            Jm_Bm = jm_gcn + bm_gcn
            jm_gcn_rgb = jm_gcn + RGB 
            Jm_Bm_rgb = jm_gcn + bm_gcn + RGB 
            ...
            bp2_gcn_rgb = bp2_gcn + RGB 
            B2_B5_rgb = bp2_gcn + bp5_gcn + RGB 
            ...
            J_B_Jm_Bm_rgb = np.argmax(j_gcn + b_gcn + jm_gcn + bm_gcn + RGB )
            right_J_B_Jm_Bm_rgb += int(J_B_Jm_Bm_rgb==int(l))

            J_B_Jm_Bm_B2_B5_rgb = np.argmax(j_gcn + b_gcn + jm_gcn + bm_gcn +bp2_gcn+bp5_gcn + RGB )
            right_J_B_Jm_Bm_B2_B5_rgb += int(J_B_Jm_Bm_B2_B5_rgb==int(l))
        ...
        print(f'ALL SUM TOGETHER ACCURACY right_J_B_Jm_Bm_rgb from {total_num} samples: {right_J_B_Jm_Bm_rgb / total_num}')
        print(f'ALL SUM TOGETHER ACCURACY right_J_B_Jm_Bm_B2_B5_rgb from {total_num} samples: {right_J_B_Jm_Bm_B2_B5_rgb / total_num}')
